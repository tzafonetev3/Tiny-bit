...
namespace Tinybit {
    ...
    export enum CarState {
        ...
        Car_Stop = 5,
        //% blockId="Car_SpinLeft" block="סחרור שמאלה"
        Car_SpinLeft = 6,
        //% blockId="Car_SpinRight" block="סחרור ימינה"
        Car_SpinRight = 7
    }
    ...
    //% blockId=Tinybit_Music_Car block="רובוט מנגן|%index"
    //% weight=95
    //% blockGap=10
    //% color="#FF5733"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=Tinybit_CarCtrl block="תנועה של הרובוט|%index"
    //% weight=93
    //% blockGap=10
    //% color="#FF5733"
    ...
    //% blockId=Tinybit_Line_Sensor block="חיישן קו|direct %direct| ערך %value"
    //% weight=89
    //% blockGap=10
    //% color="#FF5733"
    ...
    //% blockId=Tinybit_Voice_Sensor block="ערך חיישן הקול"
    //% weight=88
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=12
